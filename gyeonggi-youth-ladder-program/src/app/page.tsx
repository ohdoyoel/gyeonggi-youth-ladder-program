...
export default function Home() {
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col items-center justify-center gap-1 sm:gap-4 text-base sm:text-3xl font-semibold py-32 sm:py-60 px-4 md:px-16 lg:px-32 xl:px-60 bg-slate-50">
        <ScrollReveal variant="blur-in" delay={0}>
          <p className="text-center">경기청년사다리, 도전과 성장을 위한 여정!</p>
        </ScrollReveal>
        <ScrollReveal variant="blur-in" delay={80}>
          <p className="text-center">해외 대학 탐방과 다양한 활동을 통해</p>
        </ScrollReveal>
        <ScrollReveal variant="blur-in" delay={160}>
          <p className="text-center">새로운 시각과 경험을 제공합니다.</p>
        </ScrollReveal>
      </div>
      ...
      <div className="relative py-32 sm:py-60 px-4 md:px-16 lg:px-32 xl:px-60 flex flex-col gap-10 bg-white">
        ...
        <div className="grid grid-cols-2 w-full gap-6 sm:gap-20 mt-4 sm:mt-10">
          ...
          <ScrollReveal variant="scale-up" delay={50}>
            <div className="flex flex-col sm:flex-row gap-6 items-center">
