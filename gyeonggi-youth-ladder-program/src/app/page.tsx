...
export default function Home() {
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col items-center justify-center gap-1 sm:gap-4 text-base sm:text-3xl font-semibold py-60 px-4 md:px-16 lg:px-32 xl:px-60 bg-slate-50 animate-pulse">
        <p>경기청년사다리프로그램은 최고입니다.</p>
        <p>경기청년사다리프로그램은 최고라구요.</p>
        <p>경기청년사다리프로그램은 최고라니깐요?!</p>
      </div>
      <div className="relative py-60  px-4 md:px-16 lg:px-32 xl:px-60 sm:h-[72rem] flex flex-col gap-10 bg-white">
        ...
        <div className="flex flex-col gap-12">
          ...
          />
          <div className="flex flex-col items-end gap-1 font-medium text-[10px] sm:text-lg bottom-60  right-4 md:right-16 lg:right-32 xl:right-60">
            <p>
            ...
            <p>
              사전 교육 및 성과공유회 등 프로그램 전 일정에 참여가 가능해야
              해요.
            </p>
          </div>
        </div>
      ...
      <div className="relative py-60 px-4 md:px-16 lg:px-32 xl:px-60 flex flex-col gap-10 bg-slate-50">
        <p className="text-xl sm:text-2xl font-semibold text-slate-800">
          선발 과정
        </p>
        ...
        <div className="flex flex-col gap-20 mt-20">
          <div className="flex gap-4 sm:gap-10 h-24 sm:h-48">
            <img
          ...
          <div className="flex flex-row-reverse gap-4 sm:gap-10 h-24 sm:h-48">
            <img
              className=" h-full w-1/3 bg-cover rounded-lg shadow-lg blur-sm object-cover"
              src="/home/step2.jpg"
              alt="/step2.jpg"
          ...
          <div className="flex flex-col items-end text-xs sm:text-lg font-medium text-slate-500">
      ...
      <div className="relative py-60 px-4 md:px-16 lg:px-32 xl:px-60 flex flex-col gap-10 bg-white">
        <p className="text-xl sm:text-2xl font-semibold text-slate-800">
          지원 내용
        </p>
        <div className="flex flex-col gap-1 sm:gap-6 text-2xl sm:text-5xl font-bold">
        ...
        <div className="grid grid-cols-2 w-full gap-4 sm:gap-20 mt-10">
          <div className="flex flex-col gap-6">
            <Icon icon="twemoji:airplane" className="text-8xl sm:text-9xl" />
            <p className="text-lg sm:text-3xl font-semibold">항공권</p>
            <p className="text-md sm:text-xl font-medium text-slate-500">
              n00만원 상당의 비행기 티켓값을 지원해요.
            </p>
          </div>
          <div className="flex flex-col gap-6">
            <Icon icon="twemoji:school" className="text-8xl sm:text-9xl" />
            <p className="text-lg sm:text-3xl font-semibold">해외대학연수비</p>
            <p className="text-md sm:text-xl font-medium text-slate-500">
          ...
          <div className="flex flex-col gap-6">
            ...
            />
            <p className="text-lg sm:text-3xl font-semibold">숙식비</p>
            <p className="text-md sm:text-xl font-medium text-slate-500">
              어학원 주변 숙소와 식비를 지원해요.
            </p>
          </div>
          <div className="flex flex-col gap-6">
            <Icon
              ...
              className="text-8xl sm:text-9xl"
            />
            <p className="text-lg sm:text-3xl font-semibold">교통패스</p>
            <p className="text-md sm:text-xl font-medium text-slate-500">
              연수 기간 동안 어디든 갈 수 있도록, 교통비를 지원해요.
            </p>
          </div>
          <div className="flex flex-col gap-6">
            <Icon icon="twemoji:safety-vest" className="text-8xl sm:text-9xl" />
            <p className="text-lg sm:text-3xl font-semibold">현지 보험</p>
            <p className="text-md sm:text-xl font-medium text-slate-500">
              낯선 해외에서 무슨 일이 생겨도 안전해요.
            </p>
          </div>
          <div className="flex flex-col gap-6">
            <Icon icon="twemoji:rocket" className="text-8xl sm:text-9xl" />
      ...
      <div className="bg-white py-60 px-4 md:px-16 lg:px-32 xl:px-60  h-[30rem] flex flex-col gap-6 items-center justify-center">
